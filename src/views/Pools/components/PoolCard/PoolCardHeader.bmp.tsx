...
const Wrapper = styled(CardHeader)<{ isFinished?: boolean; backgroundStyle?: string }>`
  background: ${({ isFinished, backgroundStyle, theme }) =>
    isFinished ? theme.colors.backgroundDisabled : theme.colors.gradients[backgroundStyle]};
...
const PoolCardHeader: React.FC<{
  ...
  return (
    <Wrapper isFinished={isFinished} backgroundStyle={background}>
