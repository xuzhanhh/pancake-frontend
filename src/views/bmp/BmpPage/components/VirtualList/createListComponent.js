      ...
      class List extends PureComponent {
        ...
        constructor(props) {
          ...
          this._getStyleValue = (value) => {
            return typeof value === 'number' ? value + 'px' : value == null ? '' : value
          }
          ...
          this._getItemStyle = (index) => {
            ...
            const offset = getItemOffset(this.props, index, this, this._instanceProps)
            const size = getItemSize(this.props, index, this, this._instanceProps) // TODO Deprecate direction "horizontal"
        ...
        _getRangeToRender() {
          ...
          const startIndex = getStartIndexForOffset(this.props, scrollOffset, this, this._instanceProps)
          const stopIndex = getStopIndexForStartIndex(this.props, scrollOffset, startIndex, this, this._instanceProps) // Overscan by one item in each direction so that tab/focus works.
