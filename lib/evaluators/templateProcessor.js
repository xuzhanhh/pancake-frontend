...
function getTemplateProcessor({ types: t }, options) {
  return function process({ styled, path }, state, valueCache) {
    ...
    const parent = path.findParent(
      (p) => t.isObjectProperty(p) || t.isJSXOpeningElement(p) || t.isVariableDeclarator(p),
    )
    ...
    if (styled) {
      ...
      path.replaceWith(
        t.callExpression(
          t.callExpression(t.identifier(state.file.metadata.localName || 'styled'), [styled.component.node]),
    ...
    if (type === 'atomic-css') {
      ...
      atomicRules.forEach((rule) => {
        ...
        state.rules[rule.property] = {
          ...
          start:
            (_path$parent$loc$star =
              (_path$parent = path.parent) === null || _path$parent === void 0
                ? void 0
                : (_path$parent$loc = _path$parent.loc) === null || _path$parent$loc === void 0
                ? void 0
                : _path$parent$loc.start) !== null && _path$parent$loc$star !== void 0
              ? _path$parent$loc$star
              : null,
          className: className,
      ...
      const atomicString = t.stringLiteral(
        atomicRules // Some atomic rules produced (eg. keyframes) don't have class names, and they also don't need to appear in the object
      ...
      state.rules[selector] = {
        ...
        displayName: displayName,
        start:
          (_path$parent$loc$star2 =
            (_path$parent2 = path.parent) === null || _path$parent2 === void 0
              ? void 0
              : (_path$parent2$loc = _path$parent2.loc) === null || _path$parent2$loc === void 0
              ? void 0
              : _path$parent2$loc.start) !== null && _path$parent$loc$star2 !== void 0
            ? _path$parent$loc$star2
            : null,
      }
    }
