...
function getTemplateProcessor({
  ...
  return function process({
    ...
    if (type === 'atomic-css') {
      ...
      const atomicString = t.stringLiteral(atomicRules // Some atomic rules produced (eg. keyframes) don't have class names, and they also don't need to appear in the object
